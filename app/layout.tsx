...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Alameda Web Design" }],
  creator: "Alameda Web Design",
  publisher: "Alameda Web Design",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    siteName: "Alameda Web Design",
    title: "Alameda Web Design - Professional Web Design Services",
    description:
      "Professional web design and development services in Alameda. We focus on Inclusive design with a simple, clear layout that ensures all visitors—including those with disabilities—can easily access and interact with your content. We are experts in API integrations and engaging copy",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Alameda Web Design",
      },
    ],
  },
  // twitter: {
  //   card: 'summary_large_image',
  //   title: 'Alameda Web Design - Professional Web Development Services',
  //   description: 'Professional web design and development services in the Alameda.',
  ...
  // },
  alternates: {
    canonical: "https://alamedawebdesign.net", // 👈 canonical URL
  },
};

function LocalBusinessSchema() {
  const structuredData = {
    "@context": "https://alamedawebdesign.net",
    "@type": "LocalBusiness",
    "@id": "https://alamedawebdesign.net/#organization",
    name: "Alameda Web Design",
    url: "https://alamedawebdesign.net",
    logo: "https://alamedawebdesign.net/logo.png",
    image: "https://alamedawebdesign.net/og-image.jpg",
    description:
      "Professional web design and development services in Alameda California",
    priceRange: "$$",
